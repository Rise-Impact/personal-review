...
function index() {
  ...
  return (
    <div>
      <div className="flex justify-center  bg-gray-200 w-screen h-min">
        <div className="grid grid-cols-1 grid-rows-10 justify-items-stretch  items-center bg-gray-50 w-4/5 h-min my-6 rounded-xl shadow-md " >
          ...
          <form className=" justify-self-center  w-3/4 " action="https://docs.google.com/forms/u/0/d/e/1FAIpQLSc5-bsmsg4KJDmluRD_DbUBL0vH_he1Vz47M4fHt2a4W0hNGg/formResponse" method="post" >
            <div className="bg-transparent mb-10" >
              <p>เพื่อนๆ เรียกคุณว่าอะไร</p><p className="text-red-600">*</p>
              <input required type="text" className="w-3/4 h-12 border-2 border-gray-400 rounded-lg bg-transparent quantumWizTextinputPaperinputInput exportInput __web-inspector-hide-shortcut__" name="entry.2099007098" placeholder="Your Answer" />
            </div>

            <h1>ส่วนที่ 1 : ทบทวนการทำงานในปีที่ผ่านมา</h1>
            <div className="bg-transparent mt-4">
              <p>คุณทำงานในตำแหน่งใด</p><p className="text-red-600">*</p>
              <input required type="text" className="w-3/4 h-12 border-2 border-gray-400 rounded-lg bg-transparent quantumWizTextinputPaperinputInput exportInput __web-inspector-hide-shortcut__" name="entry.352420318" placeholder="Your Answer" />
            </div>

            <div className="bg-transparent mt-4">
              <p>บทบาทในทีม หากเทียบกับตำแหน่งในกีฬาฟุตบอลแล้ว คุณอยู่ในตำแหน่งใด ? เพราะอะไร ?</p><p className="text-red-600">*</p>
              <textarea required className="w-3/4  border-2 border-gray-400 rounded-lg bg-transparent h-32 quantumWizTextinputPapertextareaInput exportTextarea " placeholder="Your Answer" jsname="YPqjbf" data-rows="1" tabIndex="0" aria-label="Your answer" jscontroller="gZjhIf" jsaction="input:Lg5SV;ti6hGc:XMgOHc;rcuQ6b:WYd;" dir="auto" data-initial-dir="auto" aria-labelledby="i39" aria-describedby="i40 i41" badinput="false" name="entry.1665001835"></textarea>
            </div>

            <div className="bg-transparent mb-5 mt-5">
              <p>คุณรู้สึกภูมิใจในตัวเองระดับใด ?</p>
              <div className="flex w-max" >
                <div className="flex items-end">ไม่ภูมิใจเลย</div>
            ...
            <p>ในปีที่ผ่านมาคุณทำงานใดไปบ้าง ?</p>
            <div className="mb-4 bg-transparent border-2 border-gray-400 rounded-lg p-1">
              ...
              <div className="flex ">
                ...
                <div className="  w-72" >
                  <div><label>สัดส่วน(%)</label></div>
                  <input className="w-64 h-12 border-2 border-gray-400 rounded-lg" type="number"  placeholder="Your Answer" name="entry.1915041039"/>
                </div>
                <div className=" mb-5 mt-5">
                  <center><p>ความพึงพอใจ</p></center>
                  <div className="flex w-max" >
                    <div className="flex items-end">ไม่ถนัด-ไม่ชอบ-ใช้เวลา</div>
            ...
            <div className="bg-transparent border-2 border-gray-400 rounded-lg p-1">
              
              <div className="flex justify-center">
              <div className="">
                  <div className="flex justify-center"><label>Task/Project</label></div>
                  <input className="w-96 h-12 border-2 border-gray-400 rounded-lg " type="text" placeholder="Your Answer" name="entry.435432244"/>
                </div>
              </div>
              <div className="flex ">
                ...
                <div className="  w-72" >
                  <div><label>สัดส่วน(%)</label></div>
                  <input className="w-64 h-12 border-2 border-gray-400 rounded-lg" type="number"  placeholder="Your Answer" name="entry.2098581185"/>
                </div>
                <div className=" mb-5 mt-5">
                  <center><p>ความพึงพอใจ</p></center>
                  <div className="flex w-max" >
              ...
              <div className="w-72">
              <div><label><br/>ทำไมจึงรู้สึกแบบนั้น</label></div>
              <div><textarea className="w-72  border-2 border-gray-400 rounded-lg bg-transparent h-32 quantumWizTextinputPapertextareaInput exportTextarea " placeholder="Your Answer" jsname="YPqjbf" data-rows="1" tabIndex="0" aria-label="Your answer" jscontroller="gZjhIf" jsaction="input:Lg5SV;ti6hGc:XMgOHc;rcuQ6b:WYd;" required dir="auto" data-initial-dir="auto" aria-labelledby="i39" aria-describedby="i40 i41" badinput="false" name="entry.625594278"></textarea></div>
              </div>
              <div className="w-2/3 ml-1 ">
              <label>ถ้าคะแนนน้อยกว่า 6 หรือรู้สึกอยากพัฒนา คิดว่าอยากปรับปรุงหรือพัฒนาให้ดีขึ้นอย่างไร</label>
              <div><textarea className="w-96  border-2 border-gray-400 rounded-lg bg-transparent h-32 quantumWizTextinputPapertextareaInput exportTextarea " placeholder="Your Answer" jsname="YPqjbf" data-rows="1" tabIndex="0" aria-label="Your answer" jscontroller="gZjhIf" jsaction="input:Lg5SV;ti6hGc:XMgOHc;rcuQ6b:WYd;" required dir="auto" data-initial-dir="auto" aria-labelledby="i39" aria-describedby="i40 i41" badinput="false" name="entry.1156266615"></textarea></div>
              </div>
            </div>
            </div>
            ...
            <div className="bg-transparent mb-10 mt-10">
            ...
            <button className="border-2 border-gray-400 rounded-lg" type="submit">submit</button>
          </form>
